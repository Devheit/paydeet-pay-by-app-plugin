...
export interface WidgetProps extends CheckoutProps {
...
export type PayByAppWidgetComponent = (props: WidgetProps) => WidgetInstance;

export interface PaydeetPlugin {
  checkout(props: CheckoutProps): Promise<CheckoutResponse>;
  PayByAppWidget: PayByAppWidgetComponent;
}

declare const paydeet: PaydeetPlugin;
export default paydeet;
